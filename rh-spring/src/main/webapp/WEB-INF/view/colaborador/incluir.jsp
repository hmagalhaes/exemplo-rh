<%-- 
    Document   : incluir
    Created on : 28-Feb-2014, 10:03:20
...
<tiles:insertDefinition name="base">
	<tiles:putAttribute name="contentTitle"><spring:message code="colab.incluir.titulo"/></tiles:putAttribute>
	<tiles:putAttribute name="content">

<form:form commandName="formIncluirColaborador">
